...
INSERT INTO "new_User" ("approved", "approvedAt", "approvedById", "email", "id", "joinedAt", "name", "role") SELECT "approved", "approvedAt", "approvedById", "email", "id", "joinedAt", "name", "role" FROM "User";
DROP TABLE "User";
