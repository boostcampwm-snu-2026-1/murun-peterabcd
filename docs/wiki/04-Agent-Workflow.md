...
- "Agent skill" = 반복되는 작업 절차를 MD로 정리한 것. → [`.gjc/skills/murun-feature/SKILL.md`](../../.gjc/skills/murun-feature/SKILL.md) 참고.
...
→ [`06-Checkpoints.md`](./06-Checkpoints.md) 의 체크리스트를 **사람이** 본다. Agent가 "통과했다"고 적은 줄은 그대로 믿지 않는다.
